...
1. Contact the Book of Business team to request access to the Zoho webhook BY DOING BLANK and provide email address for any developer that needs access to the Zoho Sandbox.  
   1. Within X days the Book of Business team will respond to your request  
2. Once approved:  
   1. You'll receive an email with a link to your organization's authentication token ("auth_token_name" and "auth_token_value"). This link will expire after 7 days.  
   2. Your developers will be granted access to the Zoho Sandbox  
...
## How to Connect  
### Option #1
- Connect Google Sheets directly with Zoho using Google App Scripts  
...
- **Templates:**   
  ...
  - [Send_to_webhook_script.txt](https://drive.google.com/file/d/1asSxAyScKIMItP9uPccD7VJdqV2XZTPz/view?usp=drive_link)  
  - [create_trigger_script.txt](https://drive.google.com/file/d/1AD1lBP-FjldGDCq_XySFKLAMOvVlkc10/view?usp=drive_link)
...
| ----- | :---- | :---- | ----- |
| auth_token_name | auth_token_name | Email [dltrlzohodev@telus.com](mailto:dltrlzohodev@telus.com) to receive your organization's token | Yes |
...
| Quote Source | Datahub_Src | Used to help you identify where this lead originated.  Ex. Website Lead Form or [telus.com/contact](http://telus.com/contact) | Yes |
